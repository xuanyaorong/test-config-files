...
<script src="${public}/js/model/basics/properties.js" type="text/javascript"></script>
<html>
...
<div data-options="region:'north'" > 
	...
	<table>
		...
		<tr>
			<@selectinput id="bill_sysbill_f" label="单据" width="200" />
		</tr>
		<tr>
			<@selectinput id="stop_sysstop_f" label="是否启用" width="200" />
		</tr>
		<tr><@textinput id="remark_f" label="备注" colspan="7"/></tr>
		<tr>
