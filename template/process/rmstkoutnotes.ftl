...
<#include "components/businessstock.ftl">
...
<script src="${public}/js/components/businessstock.js" type="text/javascript"></script>
<script src="${public}/js/model/process/rmstkoutnotes.js" type="text/javascript"></script>
...
<div data-options="region:'center'" > 
	...
	<div class="easyui-tabs" style="height:100%;">
		<div title="商品明细">
			<@detailgrid name="dg_rmstkoutnotesdetail" columns=["\lth data-options=\"field:\'c_good_f\',width:80\">商品编码\l/th\g"
					...
					,"\lth data-options=\"field:\'taxprice_f\',width:80\">基价\l/th\g"
					,"\lth data-options=\"field:\'remark_f\',width:150,editor:'textbox'\">备注\l/th\g"
					,"\lth data-options=\"field:\'businessstockuuid_f\',width:150\" formatter='formatter_stock'>业务库存\l/th\g"
		...
		<div title="物流信息" >
			<@detailgrid name="dg_rmstkoutnotesdriver" columns=[
...
<div id="win_stock" class="easyui-window" title="录入库存信息" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:800px;height:500px;">
	<div class="easyui-layout" data-options="fit:true">
			...
			<table id="dg_stock" class="easyui-datagrid" rownumbers="true" style="width:100%;height:100%;">
				<thead>
					<tr>
						...
						<th data-options="field:'remark_f',width:150">备注</th>
		...
		<div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
				<a class="easyui-linkbutton" data-options="iconCls:'icon-ok'" href="javascript:void(0)" onclick="btn_savestkout()" style="width:80px">确定</a>
