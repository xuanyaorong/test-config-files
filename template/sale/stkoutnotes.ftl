...
<script src="${public}/js/model/sale/stkoutnotes.js" type="text/javascript"></script>
...
<div data-options="region:'center'" > 
	...
	<div class="easyui-tabs" style="height:100%;">
		<div title="商品明细">
			<@detailgrid name="dg_stkoutnotesdetail" columns=["\lth data-options=\"field:\'c_good_f\',width:80\">商品编码\l/th\g"
		...
		<div title="物流信息" >
			<@detailgrid name="dg_stkoutnotesdriver" columns=[
