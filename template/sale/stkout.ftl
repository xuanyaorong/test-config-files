...
<script src="${public}/js/model/sale/stkout.js" type="text/javascript"></script>
...
<div data-options="region:'center'" > 
			...
			<@detailgrid name="dg_stkoutdetail" columns=["\lth data-options=\"field:\'c_good_f\',width:80\">商品编码\l/th\g"
