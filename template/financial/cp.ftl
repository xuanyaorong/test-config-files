...
<script src="${public}/js/model/financial/cp.js" type="text/javascript"></script>
<html>
...
<div data-options="region:'center'" > 
			...
			<@detailgrid name="dg_cpdetail" columns=["\lth data-options=\"field:\'ccode_f\',width:150\">合同号\l/th\g"
