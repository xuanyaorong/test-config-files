...
<script src="${public}/js/model/financial/sinvoice.js" type="text/javascript"></script>
...
<form id="ff" method="post">
    ...
    <div data-options="region:'center'">
        <div class="easyui-tabs" style="height:100%;">
            <div title="单据明细">
                <@detailgrid name="dg_sinvoicedetail" columns=["\lth data-options=\"field:\'ccode_f\',width:150\">销售合同号\l/th\g"
            ...
            <div title="发票号" >
            <@detailgrid name="dg_sinvoicecodedetail" columns=["\lth data-options=\"field:\'code_f\',width:150,editor:'textbox'\">发票号码\l/th\g"
            ]/>
            </div>
        </div>
    </div>
