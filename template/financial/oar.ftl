...
<script src="${public}/js/model/financial/oar.js" type="text/javascript"></script>
<html>
...
<form id="ff" method="post">
    ...
    <div data-options="region:'center'">
         <@detailgrid name="dg_oardetail" columns=["\lth data-options=\"field:\'ccode_f\',width:150\">销售合同号\l/th\g"
