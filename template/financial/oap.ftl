...
<script src="${public}/js/model/financial/oap.js" type="text/javascript"></script>
<html>
...
<form id="ff" method="post">
    ...
    <div data-options="region:'center'">
        <@detailgrid name="dg_oapdetail" columns=["\lth data-options=\"field:\'ccode_f\',width:150\">采购合同号\l/th\g"
