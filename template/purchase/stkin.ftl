...
<script src="${public}/js/model/purchase/stkin.js" type="text/javascript"></script>
...
<div data-options="region:'center'" > 
			...
			<@detailgrid name="dg_stkindetail" columns=["\lth data-options=\"field:\'c_good_f\',width:80\">商品编码\l/th\g"
					...
					,"\lth data-options=\"field:\'pricingcode_f\',width:80\">点价单号\l/th\g"
					,"\lth data-options=\"field:\'cardnumber_f\',width:80\">卡号\l/th\g"
