...
<script src="${public}/js/model/purchase/restkin.js" type="text/javascript"></script>
...
<div data-options="region:'center'" > 
			...
			<@detailgrid name="dg_restkindetail" columns=["\lth data-options=\"field:\'c_good_f\',width:80\">商品编码\l/th\g"
					...
					,"\lth data-options=\"field:\'sourcecode_f\',width:80\">来源单号\l/th\g"
					 ...
					 showtoolbar="true" totalcolumns="qty_f,taxamount_f" editable="true"/>
