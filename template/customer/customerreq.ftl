...
<script src="${public}/js/model/customer/customerreq.js" type="text/javascript"></script>
<html>
...
<div data-options="region:'north'" > 
	...
	<table>
		<tr>
	    	...
	    	<input type="hidden" id="customer_customer_f" name="customer_customer_f"/>
...
<div data-options="region:'center'" > 
	<div class="easyui-tabs" style="height:100%;">
			<div title="基础信息">
				<table> 
					...
					<tr>
						...
						<@detailgrid name="dg_customerreqbank"
						  columns=[
										"\lth data-options=\"field:\'bankname_f\',width:80\">开户行\l/th\g"
										,"\lth data-options=\"field:\'bankcode_f\',width:80,editor:'textbox'\">银行账户\l/th\g"
										]
										editable="true"
						/>
			</div>
			<div title="其它信息" >
				<table> 
					...
					<tr>
						...
						<@detailgrid name="dg_customerrequser" 
			...
			<div title="额度" >
				 <@detailgrid name="dg_customerreqcreditdetail"
